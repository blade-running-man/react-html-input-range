...
var Range = function (_a) {
    ...
    return (React.createElement("div", { className: "input-range-container" },
        React.createElement("input", { ref: rangeRef, className: "input-range input-range_" + (vertical ? 'vertical' : 'horizontal'), type: "range", value: value, min: min, max: max, step: step, onChange: onChangeHandler, disabled: disabled })));
};
